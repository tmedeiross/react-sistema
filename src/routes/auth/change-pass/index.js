...
class ChangePass extends Component {
  ...
  onPassChange() {
    this.props.passChangeRequest(this.state.form, this.props.history);
  }
                    ...
                    <Form>
                      ...
                      <Label className="form-group has-float-label mb-4">
                        <Input
                          ...
                          onChange={this.onChange}
                        />
                        <IntlMessages id="user.pass-new" />
                      </Label>
                      <div className="d-flex justify-content-between align-items-center">
                        <Button
                          href={defaultStartPath}
                          color="secondary"
                        ...
                        <Button
                          ...
                          size="lg"
                          onClick={() => this.onPassChange()}
                        >
                          <IntlMessages id="user.button-change-pass" />
                        </Button>
                      </div>
