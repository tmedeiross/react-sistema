          ...
          <div className="mdl-card mdl-shadow--2dp">
            ...
            <div className="mdl-card__supporting-text w100">
              <form action="#" onSubmit={this.handleSubmit}>
                <p className="mdl-typography--text-center w100">{this.state.description}</p>
                ...
                <label className="mdl-radio mdl-js-radio" htmlFor="male">
                  ...
                  <span className="mdl-checkbox__label">{this.state.lbMale}</span>
                </label>
                <label className="mdl-radio mdl-js-radio ml1" htmlFor="female">
                  ...
                  <span className="mdl-checkbox__label">{this.state.lbFemale}</span>
                </label>
              </form>
            </div>
